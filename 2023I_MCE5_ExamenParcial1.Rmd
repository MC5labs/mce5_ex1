...
```{r} ```
data <- read.csv("mites.csv")
modelo_abundancia <- lm(abundancia ~ densidad_sustrato + tipo_sustrato + contenido_agua + arbustos_cercania + topografia_suelo, data = data)
summary(modelo_abundancia)
modelo_ocurrencia <- glm(ocurrencia ~ densidad_sustrato + tipo_sustrato + contenido_agua + arbustos_cercania + topografia_suelo, data = data, family = binomial)
summary(modelo_ocurrencia)
modelo_ocurrencia <- glm(ocurrencia ~ densidad_sustrato + tipo_sustrato + contenido_agua + arbustos_cercania + topografia_suelo, data = data, family = poisson)
summary(modelo_ocurrencia)
```{r} ```
